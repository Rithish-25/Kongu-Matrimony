...
class AppLanguageController {
  ...
  static final Map<String, String> _englishTranslations = {
    ...
    'bio': 'About Me',
    'download_horoscope': 'Download Horoscope',
  ...
  static final Map<String, String> _tamilTranslations = {
    ...
    ' — your trusted partner in finding lifelong companionship and happiness. we believe every individual deserves a loving, compatible life partner. our mission is to make your journey to marriage ': ' — உங்கள் வாழ்நாள் அன்பையும் மகிழ்ச்சியையும் கண்டறியும் நம்பிக்கையான தளம். ஒவ்வொரு நபரும் தகுதியான வாழ்க்கை துணையை பெற தகுதியானவர் என நம்புகிறோம். உங்கள் திருமண பயணத்தை ',
    'simple, safe, and successful': 'எளிதாகவும், பாதுகாப்பாகவும், வெற்றிகரமாகவும்',
    ' by combining timeless traditional values with modern, intuitive technology.': ' பாரம்பரிய கலாச்சார மதிப்புகளுடன் நவீன தொழில்நுட்பத்தை இணைத்து அமைப்பதே எங்கள் நோக்கம்.',
    'platform at a glance': 'தளத்தின் சிறப்பம்சங்கள்',
    'registered\nmembers': 'பதிவு செய்த\nஉறுப்பினர்கள்',
    'successful\nmatches': 'வெற்றிகரமான\nதிருமணங்கள்',
    'days of\nsupport': 'ஆண்டு முழுதும்\nசேவை',
    'ready to find your partner?': 'உங்கள் வாழ்க்கை துணையை கண்டறிய தயாரா?',
    'join thousands of happy members who found their life partner on kongu kootamaipu™.': 'கொங்கு கூட்டமைப்பில் தங்களது வாழ்க்கை துணையை கண்டறிந்த ஆயிரக்கணக்கான குடும்பங்களில் இணையுங்கள்.',
    'create free profile': 'இலவச சுயவிவரத்தை உருவாக்கு',
    ...
    'skip step': 'தவிர்க்கவும்',
    'skip & finish': 'தவிர்த்து முடிக்க',
    'next step': 'அடுத்த படி',
    'submit & finish': 'சமர்ப்பிக்க',
    ...
    'no. of brothers': 'சகோதரர்கள்',
    'no. of sisters': 'சகோதரிகள்',
    'sisters married': 'திருமணமானவர்',
    'brothers married': 'திருமணமானவர்',
